...
SELECT * FROM TBL_PARKING_202301 WHERE CAR_NUMBER='11가1111';
SELECT * FROM TBL_CAR_202301 C JOIN TBL_PARKING_202301 P ON C.CAR_NUMBER = P.CAR_NUMBER WHERE C.CAR_NUMBER='11가1111';